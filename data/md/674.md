...
Find the sum of least simultaneous values of all $\mathcal{I}$-expressions pairs made of distinct expressions from file [I-expressions.txt](../documents/0674_i_expressions.txt) (pairs $(e\_1,e\_2)$ and $(e\_2,e\_1)$ are considered to be identical). Give the last nine digits of the result as the answer.