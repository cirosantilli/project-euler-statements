...
![0296_bisector.gif](../images/0296_bisector.gif)

How many triangles $ABC$ with a perimeter not exceeding $1\,000\,000$ exist such that $CE$ has integral length?

**Note**: This problem is a more difficult version of [Problem 296](problem=296). Please pay close attention to the differences between the two statements.