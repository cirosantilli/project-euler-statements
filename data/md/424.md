...
![0424_kakuro1.gif](../images/0424_kakuro1.gif)
...
The downloadable text file ([kakuro200.txt](../documents/0424_kakuro200.txt)) contains the description of 200 such puzzles, a mix of 5x5 and 6x6 types. The first puzzle in the file is the above example which is coded as follows:
