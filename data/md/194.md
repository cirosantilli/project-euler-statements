...
Consider graphs built with the units $A$: ![](../images/0194_GraphA.png)
and $B$: ![](../images/0194_GraphB.png), where the units are glued along
the vertical edges as in the graph ![](../images/0194_Fig.png).
