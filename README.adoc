...
* link:data/minimal[data/minimal]: HTML from `https://projecteuler.net/minimal=X` e.g. https://projecteuler.net/minimal=949
* link:data/problem[data/problem]: HTML from `https://projecteuler.net/problem=X` e.g. https://projecteuler.net/problem=949
* link:data/documents[data/documents]: files from under `https://projecteuler.net/resources/documents/` e.g. https://projecteuler.net/resources/documents/0042_words.txt at link:data/documents/0042_words.txt[data/documents/0042_words.txt]. These are required as input data to solve some of the problems.
* link:data/md[data/md]: local conversion of the above HTML downloads to a nice Markdown format
* link:data/lean[data/lean]: formal link:https://lean-lang.org/[Lean] statements of the problems
* link:data/meta[data/meta]: JSON problem metadata extracted from the HTML e.g.: link:data/meta/1.json[data/meta/1.json] contains:
+
[source,json]
----
{
